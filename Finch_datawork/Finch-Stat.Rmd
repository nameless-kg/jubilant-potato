...
```{r, echo = FALSE, 'Reordering the data for accessibility'}
  finch_smry_ordered <- finch_smry %>%
  dplyr::select( 
    Species,
    BodyL_Mean_SD,
    BodyL_var,  # The first, second and third statistical moments for each sample are reordered to sit adjacent to one another.
    WingL_Mean_SD, #..............
    WingL_var,
    TailL_Mean_SD,#................
    TailL_var,
...
# You can also visualize the PCA results, for example, a scree plot
